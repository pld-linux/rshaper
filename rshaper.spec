...
rshaper to moduł dla jąder Linuksa w wersjach 2.0, 2.2 i 2.4, służący
do ograniczania pasma przychodzących pakietów przeznaczonych dla
różnych hostów/portów.

Ten pakiet zawiera narzędzie do sterowania modułem rshaper.
...
Moduł jądra Linuksa do ograniczania pasma w sieci.
